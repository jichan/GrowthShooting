...
public static class ConstantsClassCreator
{
	...
	static readonly string extension = ".cs";
	static readonly string autoCreatingConstants = "Assets/Scripts/Constants/AutoCreating/";
	...
	private static readonly string floatName = "float";
	...
	public static void Create<T>(string className, string classInfo, Dictionary<string, T> valueDic)
	{
		...
		//書き出し、ファイル名はクラス名.cs
		string exportPath = autoCreatingConstants + className + extension;
		...
		Debug.Log(className + extension + "の作成が完了しました");
	}
